<div class="">
    ...
    <div class="mb-5">
        ...
        <h1 class="titulo-seccion text-3xl font-thin text-gray-500 mb-3">Dependencias</h1>
        ...
        <div class="flex justify-between">
            ...
            @can('Crear dependencia')
                ...
                <button wire:click="openModalCreate" class="bg-gray-500 hover:shadow-lg hover:bg-gray-700 float-right mb-5 text-sm py-2 px-4 text-white rounded-full focus:outline-none hidden md:block">Agregar nueva Dependencia</button>
                    ...
                    @foreach($dependencies as $dependency)
                        ...
                        <tr class="text-sm font-medium text-gray-500 bg-white flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                @if($dependency->created_by != null)

                                    <span class="font-semibold">Registrado por: {{$dependency->createdBy->name}}</span> <br>
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                @if($dependency->updated_by != null)

                                    <span class="font-semibold">Actualizado por: {{$dependency->updatedBy->name}}</span> <br>
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b lg:table-cell relative lg:static">
                                ...
                                <div class="flex justify-center lg:justify-start">
                                    ...
                                    @can('Editar dependencia')
                                        ...
                                        <button
                                            wire:click="openModalEdit({{$dependency}})"
                                            wire:loading.attr="disabled"
                                            wire:target="openModalEdit({{$dependency}})"
                                    ...
                                    @can('Borrar dependencia')
                                        ...
                                        <button
                                            wire:click="openModalDelete({{$dependency}})"
                                            wire:loading.attr="disabled"
                                            wire:target="openModalDelete({{$dependency}})"
