            ...
            <table class="rounded-lg w-full">
                ...
                <thead class="border-b border-gray-300 bg-gray-50">
                    ...
                    <tr class="text-xs font-medium text-gray-500 uppercase text-left traling-wider">
                        ...
                        <th wire:click="order('location_id')" class="cursor-pointer px-3 py-3 hidden lg:table-cell">
        ...
        <x-slot name="content">
            ...
            <div class="flex-auto mb-5">
                ...
                <div>
                    ...
                    <select class="bg-white rounded text-sm w-full" wire:model.defer="location_id">
                ...
                <div>
                    ...
                    @error('location_id') <span class="error text-sm text-red-500">{{ $message }}</span> @enderror
