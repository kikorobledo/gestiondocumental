<div class="">
    ...
    <div class="mb-5">
        ...
        <h1 class="titulo-seccion text-3xl font-thin text-gray-500 mb-3">Seguimientos</h1>
        ...
        <div class="flex justify-between">
            ...
            @can('Crear seguimiento')
                ...
                <button wire:click="openModalCreate" class="bg-gray-500 hover:shadow-lg hover:bg-gray-700 float-right mb-5 text-sm py-2 px-4 text-white rounded-full focus:outline-none hidden md:block">Agregar nuevo Seguimiento</button>
            ...
            <table class="rounded-lg w-full">
                ...
                <thead class="border-b border-gray-300 bg-gray-50">
                    ...
                    <tr class="text-xs font-medium text-gray-500 uppercase text-left traling-wider">
                        ...
                        <th wire:click="order('oficio_respuesta')" class="cursor-pointer px-3 py-3 hidden lg:table-cell">

                            Oficio de respuesta

                            @if($sort == 'oficio_respuesta')
                        ...
                        <th wire:click="order('fecha_respuesta')" class="cursor-pointer px-3 py-3 hidden lg:table-cell">

                            Fecha de respuesta

                            @if($sort == 'fecha_respuesta')
                        ...
                        <tr class="text-sm font-medium text-gray-500 bg-white flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                @if($tracking->created_by != null)
                                    ...
                                    <span class="font-semibold">Registrado por: {{$tracking->createdBy->name}}</span> <br>
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                @if($tracking->updated_by != null)

                                    <span class="font-semibold">Actualizado por: {{$tracking->updatedBy->name}}</span> <br>
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b lg:table-cell relative lg:static">
                                ...
                                <div class="flex justify-center lg:justify-start">
                                    ...
                                    @can('Editar seguimiento')
                                        ...
                                        <button
                                            wire:click="openModalEdit({{$tracking}})"
                                            wire:loading.attr="disabled"
                                            wire:target="openModalEdit({{$tracking}})"
                                    ...
                                    @can('Borrar seguimiento')
                                        ...
                                        <button
                                            wire:click="openModalDelete({{$tracking}})"
                                            wire:loading.attr="disabled"
                                            wire:target="openModalDelete({{$tracking}})"
            ...
            <div class="flex flex-col md:flex-row justify-between md:space-x-3 mb-5">
                ...
                <div class="flex-auto ">
                    ...
                    <div>
                        ...
                        <input type="text" class="bg-white rounded text-sm w-full" wire:model.defer="oficio_respuesta">

                    </div>

                    <div>

                        @error('oficio_respuesta') <span class="error text-sm text-red-500">{{ $message }}</span> @enderror
                ...
                <div class="flex-auto ">
                    ...
                    <div>
                        ...
                        <input type="date" class="bg-white rounded text-sm w-full" wire:model.defer="fecha_respuesta">

                    </div>

                    <div>

                        @error('fecha_respuesta') <span class="error text-sm text-red-500">{{ $message }}</span> @enderror
